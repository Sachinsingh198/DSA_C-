...
int main() {
    ...
    dll.insertAtStart(1);
    dll.display();
    delete_same_neighbours(dll.head, dll.tail);
    dll.display();
    std::cout << "Head: " << dll.head->data << "\tTail: " << dll.tail->data << std::endl;
    std::cout << "Is Palindrome: " << (dll.isPalindrome() ? "Yes" : "No") << std::endl;
